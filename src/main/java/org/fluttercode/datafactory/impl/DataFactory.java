...
public final class DataFactory {
	...
	public int getPincode() {
		return getItem(addressDataValues.getPincodes());
	}
	 ...
	 * @return random decimal number no more than max
	 */
	public double getRealNumberUpTo(final int max) {
		return getRealNumberBetween(0, max);
	}

	/**
	 * Returns a decimal number betwen min and max
	 *
	 * @param min minimum value of result
	 * @param max maximum value of result
	 * @return Random decimal number within range
	 */
	public double getRealNumberBetween(final int min, final int max) {
	...
	/**
	 * Returns a random long value of fixed len.
	 *
	 * @return random number
	 */
	public long getFixedLenNumber(int totalDigit) {
		String result = "";
	 ...
	 */
	public int getIntNumberUpTo(final int max) {
		return getIntNumberBetween(0, max);
	}
	 ...
	 */
	public int getIntNumberBetween(final int min, final int max) {
	...
	public String getRandomAlphaNumericCaps(final int length) {
		return getRandomAlphaNumericCaps(length, length);
	}

	public String getRandomAlphaNumericCaps(final int minLength, final int maxLength) {
		validateMinMaxParams(minLength, maxLength);
		StringBuilder sb = new StringBuilder(maxLength);
		...
		while (length > 0) {
			if(getBooleanValue()) sb.append((char) (random.nextInt(10) + '0'));
	...
	public String getRandomAlphaNumeric(final int length) {
		return getRandomAlphaNumeric(length, length);
	}

	public String getRandomAlphaNumeric(final int minLength, final int maxLength) {
		validateMinMaxParams(minLength, maxLength);
		StringBuilder sb = new StringBuilder(maxLength);
